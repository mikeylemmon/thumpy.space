...
func runRoboUser1() {
	...
	downOn := &api.MidiEvent{Kind: `noteon`, Channel: 1, Note: 35, Attack: 1}
	downOff := &api.MidiEvent{Kind: `noteoff`, Channel: 1, Note: 35, Attack: 1}
	upOn := &api.MidiEvent{Kind: `noteon`, Channel: 10, Note: 35, Attack: 0.5}
	upOff := &api.MidiEvent{Kind: `noteoff`, Channel: 10, Note: 35, Attack: 0.5}
