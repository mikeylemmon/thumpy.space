...
import { AABB, Body, Material, ContactMaterial, IContactMaterialOptions, Plane, Quaternion, Vec3, World } from 'cannon'
import { Obj } from './Obj'
import { Collidable } from './components/Collidable'

export const matDefault = new Material('matDefault')
export const cmatDefaultDefault = new ContactMaterial(matDefault, matDefault, {
	friction: 0.4,
	restitution: 0.3,
...
export class Engine3D {
	...
	constructor(opts: Engine3DOpts = {}) {
		...
		this.world.addContactMaterial(cmatDefaultDefault)
	}
